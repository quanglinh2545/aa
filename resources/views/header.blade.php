            ...
            <div class="container">
                <div class="pull-left auto-width-left">
                    <ul class="top-menu menu-beta l-inline">
                        <li><a href=""><i class="fa fa-home"></i> Nguyễn Quang Linh _ 20176801</a></li>
                        <li><a href=""><i class="fa fa-phone"></i> 0327182545</a></li>
                    </ul>
                </div>
						...
						<div class="cart">
                            ...
                            @endforeach
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Subtotal: <span class="cart-total-value">{{ Session('cart')->totalPrice }}</span></div>
									<div class="clearfix"></div>
