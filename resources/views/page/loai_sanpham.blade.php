								...
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="{{ route('chitietsanpham',$sp->id)}}"><img src="/source/image/product/{{$sp->image}}" alt=""  height = 240px></a>
										</div>
						...
						<div class="beta-products-list">
							...
							@foreach($sp_khac as $spk)
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="{{ route('chitietsanpham',$spk->id)}}"><img src="/source/image/product/{{$spk->image}}" alt="" height = 240px></a>
										</div>
										<div class="single-item-body">
