             ...
             <div class="row">
                 <div class="col-sm-12">
                     <div class="beta-products-list">
                                        ...
                                        <div class="row" style="padding-center: 30px align = center">
                                     
                                           <a class="btn btn-primary" href="{{route('create')}}">Tạo sản phẩm mới </a>
					</div>
                     ...
                     <div class="beta-products-list">
                         ...
                         @foreach($sanpham_khuyenmai as $spkm)
                             <div class="col-sm-3">
                                 <div class="single-item">
                                     <div class="single-item-header">
                                         <a href="{{ route('chitietsanpham',$spkm->id)}}"><img src="source/image/product/{{$spkm->image}}" alt="" height = 240px></a>
                                     </div>
                                     <div class="single-item-body">
